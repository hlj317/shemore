  ...
  <div id="hello"
    ...
    <section>
        <div class="avatar">
			...
			<rect class="left-eyebrow" x="298.77" y="111.636" fill="#33334f" width="28.152" height="8.033"></rect>
			</g>
			<!-- RIGHT EYEBROW -->
			<g>
			<line fill="#33334f" x1="349.655" y1="115.653" x2="379.206" y2="115.653"></line>
			<rect class="right-eyebrow" x="349.655" y="111.636" fill="#33334f" width="29.551" height="8.033"></rect>
			</g>
			<!-- EYES -->
			<g><circle class="left-eye" fill="#33334f" cx="313.503" cy="137.523" r="8.294" style="transform-origin: 50% 50%; transform: scaleY(1);"></circle></g>
			<g><circle class="right-eye" fill="#33334f" cx="364.964" cy="137.523" r="8.295" style="transform-origin: 50% 50%; transform: scaleY(1);"></circle></g>
			<!-- JAW -->
